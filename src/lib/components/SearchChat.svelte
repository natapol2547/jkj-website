...
function getCompanySearchResults(message: UIMessage) {
	...
	const companySearchResults = $derived.by(() => {
        ...
        const uniqueResults = results.filter((result, index, self) =>
            index === self.findIndex((t) => t.document_id === result.document_id)
        );
        ...
        <div class="flex-1 overflow-y-auto px-4 py-6 md:px-8">
            ...
            {#each chat.messages as message, messageIndex (messageIndex)}
                ...
                {#if message.role === 'assistant'}
                    ...
                    <!-- AI Response -->
                    <div class="max-w-3xl">
                        <div class="prose prose-invert prose-headings:my-0 max-w-none" in:fly={{ y: 20, duration: 400 }}>
                            <div class="flex items-start gap-3 mb-4">
                                ...
                                <div class="flex-1 w-full overflow-y-auto">
                                    ...
                                    <div class="text-slate-300 leading-relaxed space-y-3 inline-flex items-center gap-2 rounded-lg bg-[#1a1a1a] border border-slate-700/50 px-4 py-2 w-full min-h-16 overflow-y-auto">
                                        <!-- Tool -->
                                        ...
                                        {#if lastAIResponse}
                                            ...
                                            <div in:fade={{ duration: 300, delay: 300 }}>
                                                ...
                                                {#if companies}
                                                    <details class="group mt-4 rounded-xl border border-slate-700/50 bg-[#141414] overflow-hidden transition-all hover:border-violet-500/30" name="data-accordion">
                                                        <summary class="flex cursor-pointer items-center justify-between px-4 py-3 font-medium text-slate-300 transition-colors hover:bg-[#1a1a1a] hover:text-white">
                                                            <div class="flex items-center gap-2">
                                                                <Building2 class="h-4 w-4 text-violet-400" />
                                                                <span>ดูผลการค้นหาทั้งหมด</span>
                                                                <span class="ml-2 rounded-full bg-violet-500/20 px-2 py-0.5 text-xs text-violet-400">{companies.totalResults}</span>
                                                            </div>
                                                            <ChevronRight class="h-4 w-4 text-slate-500 transition-transform group-open:rotate-90" />
                                                        </summary>
                                                            ...
                                                            <div class="space-y-2">
                                                                {#each companies.results as company, i}
                                                                    <a 
                                                                        ...
                                                                        class="group/item flex items-start gap-3 rounded-lg border border-slate-800/50 bg-[#141414] p-3 transition-all hover:border-violet-500/50 hover:bg-[#1a1a1a] no-underline"
                                                                        target="_blank"
                                                                    >
            ...
            {#if companySearchResults}
                ...
                <div class="space-y-3">
                    {#each companySearchResults.results as company, i}
                        ...
                        <div
                            class="group rounded-xl border border-slate-800/50 bg-[#141414] p-4 transition-all hover:border-slate-700 hover:bg-[#1a1a1a]"
